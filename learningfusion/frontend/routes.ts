...
export const views: ViewRoute[] = [
  // for client-side, place routes below (more info https://vaadin.com/docs/v19/flow/typescript/creating-routes.html)
  {
    ...
    component: 'hello-worldfusion-view',
    title: 'Hello-World-fusion',
    action: async () => {
      await import('./views/helloworldfusion/hello-worldfusion-view');
    },
  },
  {
    path: 'about-flow',
    component: 'about-flow-view',
    title: 'About-Flow',
    action: async () => {
      await import('./views/aboutflow/about-flow-view');
    },
  },
  {
    path: 'about-fusion',
