package com.example.application.views.masterdetailflow;
...
@Route(value = "master-detail-flow")
@PageTitle("Master-Detail-Flow")
@CssImport("./views/masterdetailflow/master-detail-flow-view.css")
public class MasterDetailFlowView extends Div {
    ...
    public MasterDetailFlowView(@Autowired SamplePersonService samplePersonService) {
        addClassName("master-detail-flow-view");
