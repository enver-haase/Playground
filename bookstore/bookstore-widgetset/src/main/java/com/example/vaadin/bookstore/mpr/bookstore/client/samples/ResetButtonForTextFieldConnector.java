package com.example.vaadin.bookstore.mpr.bookstore.client.samples;
...
import com.example.vaadin.bookstore.mpr.bookstore.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.example.vaadin.bookstore.mpr.bookstore.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
